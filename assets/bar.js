...
(function enforceDemoLogin(){
    ...
    var authenticated = sessionStorage.getItem('mobDemoAuthenticated') === '1' ||
        localStorage.getItem('mobDemoAuthenticated') === '1';

    if (!publicPages.includes(currentPage) && !authenticated) {
